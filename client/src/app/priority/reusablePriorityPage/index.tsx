...
const ReusablePriorityPage = ({ priority }: Props) => {
  ...
  return <div className="m-5 p-4">
      ...
      <Header name="Priority Page" buttonComponent={
         <button 
            className="mr-3 rounded bg-blue-600 px-4 py-2 text-white font-bold hover:bg-blue-800"
      ...
      <button
          className={`px-4 py-2 ${
            view === "list" ? "bg-gray-400" : "bg-white dark:text-white dark:bg-dark-seconday"
          } rounded-l`}
        ...
        <button
          className={`px-4 py-2 ${
            view === "table" ? "bg-gray-400" : "bg-white dark:text-white dark:bg-dark-seconday"
          } rounded-r`}
