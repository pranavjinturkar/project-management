    ...
    <div className={sidebarClassNames}>
      <div className="flex h-[100%] flex-col justify-start">
        ...
        <div className="z-50 flex min-h-[56px] w-64 items-center justify-between bg-white px-6 pt-3 dark:bg-black">
          <div className="font-serif text-xl font-bold tracking-wide text-gray-800 dark:text-white">
            FLOWFY
          </div>
        ...
        {/* Team */}
        <div className="flex items-center gap-5 border-y-[1.5px] border-gray-200 px-8 py-5 dark:border-gray-700">
          <Image
            src={"https://pm-bucket-s3-images.s3.ap-south-1.amazonaws.com/flowfyLogo.jpeg"}
            alt="Logo"
            width={40}
            height={40}
            className="rounded"
